"""Common arguments for train and evaluation for CPPFNet"""
import argparse


def cppfnet_arguments():
    ...
    parser.add_argument('-i', '--dataset_path',
                        ...
                        help='path to the processed dataset. Default: ../dataset/modelnet40_ply_hdf5_2048')
    ...
    parser.add_argument('--noise_type', default='clean', choices=['clean', 'jitter', 'crop'],
    ...
    # Model
    parser.add_argument('--method', type=str, default='cppfnet', choices=['cppfnet'],
                        help='Model to use. Note: Only cppfnet is supported for training.'
                             '\'eye\' denotes identity (no registration), \'gt\' denotes groundtruth transforms')
    # PointNet settings
    parser.add_argument('--radius', type=float, default=10, help='Neighborhood radius for computing pointnet features')
    ...
    parser.add_argument('--num_reg_iter', type=int, default=10,
    ...
    parser.add_argument('--resume', default='model-best0602.pth', type=str, metavar='PATH',
...
def cppfnet_train_arguments():
    """Used only for training"""
    parser = argparse.ArgumentParser(parents=[cppfnet_arguments()])
    ...
    parser.description = 'Train CPPFNet'
    return parser


def cppfnet_eval_arguments():
    ...
    parser.add_argument('--file_path', type=str, default='',
                        help='Enter the cropped point cloud file')

    parser.description = 'CPPFNet evaluation'
    return parser
